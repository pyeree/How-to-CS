...
SRC_REPO = "https://github.com/gyoogle/tech-interview-for-developer.git"

# _source(gyoogle 원본 클론)가 없으면 자동으로 받아온다 (셋업 함정 제거)
def ensure_source():
    if os.path.isdir(os.path.join(SRC, "Computer Science")):
        return
    print(f"_source 없음 → gyoogle 원본 클론: {SRC_REPO}")
