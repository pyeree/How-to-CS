...
> I/O 작업은 Kernel level에서만 수행할 수 있다. 따라서, [[Process vs Thread|Process]], Thread는 커널에게 I/O를 요청해야 한다.
...
1. #### Blocking I/O
   ...
   * 특징
   ...
   이로 인해, 많아진 Threads 로 *[[PCB & Context Switcing|컨텍스트 스위칭]] 횟수가 증가함,,, 비효율적인 동작 방식*
