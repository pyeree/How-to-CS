...
- ##### [[B Tree & B+ Tree|B-Tree]] 자료구조

  [[Binary Search|이진 탐색]]트리와 유사한 자료구조
...
- ##### B+Tree 자료구조
  ...
  값을 리프노드에만 저장하며 리프노드들 끼리는 [[Linked List|링크드 리스트]]로 연결되어 있다 → 때문에 부등호문 연산에 대해 효과적이다.

  리프 노드를 제외한 노드들은 포인터의 역할만을 수행한다.

- ##### HashTable 자료구조

  [[Hash|해시]] 함수를 이용해서 값을 인덱스로 변경 하여 관리하는 자료구조
