...
출처: gyoogle
---
## PCB & [[PCB & Context Switcing|Context Switching]]

<br>

#### [[Process vs Thread|Process]] Management

> CPU가 프로세스가 여러개일 때, [[CPU Scheduling|CPU 스케줄링]]을 통해 관리하는 것을 말함
...
보통 [[Interrupt|인터럽트]]가 발생하거나, 실행 중인 CPU 사용 허가시간을 모두 소모하거나, 입출랙을 위해 대기해야 하는 경우에 Context Switching이 발생
