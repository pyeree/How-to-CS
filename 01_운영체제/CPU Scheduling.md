...
> CPU 를 잘 사용하기 위해 [[Process vs Thread|프로세스]]를 잘 배정하기
...
- 선점 스케줄링
    ...
    2. Round Robin
        ...
        - 할당 시간(`Time Quantum`)이 크면 FCFS와 같게 되고, 작으면 문맥 교환 ([[PCB & Context Switcing|Context Switching]]) 잦아져서 오버헤드 증가
