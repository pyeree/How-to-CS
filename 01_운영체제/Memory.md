...
>
> [[Process vs Thread|프로세스]]가 실행되려면 프로그램이 메모리에 올라와야 함
...
swapping 기법을 통해 공간을 바꿔치기하는 2번 방법과 달리 1번 방법은 사용자에게 [[Paging and Segmentation|페이징]] 시스템을 들킬 가능성이 매우 높다.
